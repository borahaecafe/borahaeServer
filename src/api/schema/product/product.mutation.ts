...
export const productMutation = extendType({
    ...
    definition(t) {
        t.field("createProduct", {
            ...
            resolve: async (_, { proudct: { price, stock, title }, userID }, { req }): Promise<any> => {
        ...
        t.field("deleteProduct", {
            ...
            resolve: async (_, { productID, userID }): Promise<any> => {
                return await prisma.$transaction(async () => {
                    ...
                    if (!user) throw new GraphQLError("No user exist")


                    if (!productID) throw new GraphQLError("Product does not exist.")
        ...
        t.field("updateProduct", {
            ...
            resolve: async (_, { title, price, stock, productID, userID }): Promise<any> => {
                return await prisma.$transaction(async () => {
