...
export const requestMutation = extendType({
    ...
    definition(t) {
        t.field("createProductRequest", {
            ...
            resolve: async (_, { vendorID, productID }): Promise<any> => {
        ...
        t.field("updateRequest", {
            ...
            resolve: async (_, { userID, requestID, status }): Promise<any> => {
                return await prisma.$transaction(async () => {
        ...
        t.field("deleteProductRequest", {
            ...
            resolve: async (_, { userID, productID }): Promise<any> => {
                return await prisma.$transaction(async () => {
        ...
        t.field("pulloutRequest", {
            ...
            resolve: async (_, { userID, productID, quantity }): Promise<any> => {
        ...
        t.field("restockrequest", {
            ...
            resolve: async (_, { userID, productID, stock }: any): Promise<any> => {
